# VeloTrack PWA Testing Guide

This guide provides instructions for testing the PWA manifest implementation (US-5.5).

## Prerequisites

- VeloTrack running on a publicly accessible HTTPS URL (required for PWA)
...
1. Open VeloTrack in Chrome desktop browser
...
1. Open VeloTrack in Chrome for Android
...
5. Verify icon preview shows VeloTrack car icon with gradient
6. Confirm installation

### 2.2 Home Screen Verification

1. Go to Android home screen
2. Locate "VeloTrack" app icon
...
1. Launch VeloTrack from home screen icon
...
1. Open VeloTrack in Safari (iOS 15+)
2. Tap Share button (box with arrow pointing up)
3. Scroll down and tap "Add to Home Screen"
4. Verify icon preview shows VeloTrack car icon
5. Edit name if desired (default: "VeloTrack")
6. Tap "Add"
...
1. Open VeloTrack in Samsung Internet
...
1. Open VeloTrack in Edge for Android
...
1. Open VeloTrack in Firefox Android
...
**Symptoms:** Default browser icon shown instead of VeloTrack icon
...
3. Android home screen with VeloTrack icon
4. Android standalone mode (no browser UI)
5. iOS home screen with VeloTrack icon
