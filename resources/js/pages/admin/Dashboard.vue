 ...
 * Will be expanded with user management and settings in Sprint 6.
 */
                    ...
                    <div class="mb-4">
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <p>
                                ...
                                <span
                                    class="ml-1 inline-flex items-center rounded-full bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:bg-red-900/20 dark:text-red-200"
                                >
                                    {{ authStore.user?.role }}
                                </span>
                            </p>
