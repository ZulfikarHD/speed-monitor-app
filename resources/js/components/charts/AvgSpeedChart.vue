...
/**
 * Average Speed vs Standard Speed Chart
 *
 * Bar chart comparing each trip's average speed against the speed limit.
...
<template>
    <div class="rounded-xl border border-zinc-200 dark:border-white/5 bg-white/95 dark:bg-zinc-800/95 ring-1 ring-white/20 dark:ring-white/5 p-5 shadow-lg shadow-zinc-900/5 dark:shadow-cyan-500/5">
        <div class="mb-4">
            <h3 class="text-base font-semibold text-zinc-900 dark:text-white">Kec. Rata-Rata vs Standar</h3>
            <p class="mt-0.5 text-xs text-zinc-500 dark:text-zinc-400">Perbandingan kecepatan rata-rata dengan batas kecepatan</p>
        </div>
